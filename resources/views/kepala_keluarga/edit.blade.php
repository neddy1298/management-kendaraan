@extends('layouts.app', ['page' => 'Master Data', 'page2' => 'Kepala Keluarga', 'page3' => 'edit'])
    ...
    <div class="row">
        <div class="col-sm-12 col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('kepala_keluarga.update', $kepala_keluarga->nkk) }}" enctype="multipart/form-data">
                        @csrf
                        <!-- Row start -->
                        <div class="row">
                            <div class="col-xl-12 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control {{ $errors->has('nkk') ? 'is-invalid' : '' }}"
                                        id="nkk" value="{{ $kepala_keluarga->nkk }}" name="nkk" disabled>
                                    @if ($errors->has('nkk'))
                            ...
                            <div class="col-xl-12 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="nama_kepala_keluarga" value="{{ $kepala_keluarga->nama_kepala_keluarga }}"
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control {{ $errors->has('rt') ? 'is-invalid' : '' }}"
                                        id="rt" value="{{ $kepala_keluarga->rt }}" name="rt">
                                    @if ($errors->has('rt'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('rt') }}
                                        </div>
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control {{ $errors->has('rw') ? 'is-invalid' : '' }}"
                                        id="rw" value="{{ $kepala_keluarga->rw }}" name="rw">
                                    @if ($errors->has('rw'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('rw') }}
                                        </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="inputalamat" rows="3" name="alamat">{{ $kepala_keluarga->alamat }}</textarea>
                                </div>
                            </div>
                        </div>
                        <!-- Row end -->
