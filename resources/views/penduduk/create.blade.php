@extends('layouts.app', ['page' => 'Master Data', 'page2' => 'Penduduk', 'page3' => 'create'])
        ...
        <div class="col-sm-12 col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Tambah Data Penduduk Baru</div>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <select class="select-single js-states form-control" title="Masukkan nkk"
                                        ...
                                        <option hidden value="{{ old('nkk') }}">{{ old('nkk') }}</option>
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select {{ $errors->has('jenis_kelamin') ? 'is-invalid' : '' }}"
                                        id="inputJenisKelamin" value="{{ old('jenis_kelamin') }}" name="jenis_kelamin">
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="tempat_lahir" value="{{ old('tempat_lahir') }}" name="tempat_lahir">
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="kelurahan" value="{{ old('kelurahan') }}" name="kelurahan_desa">
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="kecamatan" value="{{ old('kecamatan') }}" name="kecamatan">
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="kabupaten" value="{{ old('kabupaten') }}" name="kabupaten">
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="provinsi" value="{{ old('provinsi') }}" name="provinsi">
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="agama" value="{{ old('agama') }}" name="agama">
                                    @if ($errors->has('agama'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('agama') }}
                                        </div>
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="status" value="{{ old('status') }}" name="status">
