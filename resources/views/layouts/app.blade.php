...
<head>
  ...
  ************ -->
    ...
    <!-- Scrollbar CSS -->
    <link rel="stylesheet" href="{{ secure_asset('asset('vendor/overlay-scroll/OverlayScrollbars.min.css') }}">
...
<body>
  ...
  ************* -->
    ...
    <!-- Overlay Scroll JS -->
    <script src="{{ secure_asset('asset('vendor/overlay-scroll/jquery.overlayScrollbars.min.js') }}"></script>
    <script src="{{ secure_asset('asset('vendor/overlay-scroll/custom-scrollbar.js') }}"></script>
