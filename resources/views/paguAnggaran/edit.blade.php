                            ...
                            <div class="col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('januari') is-invalid @enderror"
                                        id="januari" name="januari" value="{{ $paguAnggaran->anggaranPerbulan->januari }}">
                                    @error('januari')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('februari') is-invalid @enderror"
                                        id="februari" name="februari" value="{{ $paguAnggaran->anggaranPerbulan->februari }}">
                                    @error('februari')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('april') is-invalid @enderror"
                                        id="april" name="april" value="{{ $paguAnggaran->anggaranPerbulan->april }}">
                                    @error('april')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('mei') is-invalid @enderror"
                                        id="mei" name="mei" value="{{ $paguAnggaran->anggaranPerbulan->mei }}">
                                    @error('mei')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('juni') is-invalid @enderror"
                                        id="juni" name="juni" value="{{ $paguAnggaran->anggaranPerbulan->juni }}">
                                    @error('juni')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('juli') is-invalid @enderror"
                                        id="juli" name="juli" value="{{ $paguAnggaran->anggaranPerbulan->juli }}">
                                    @error('juli')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('agustus') is-invalid @enderror"
                                        id="agustus" name="agustus" value="{{ $paguAnggaran->anggaranPerbulan->agustus }}">
                                    @error('agustus')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('september') is-invalid @enderror"
                                        id="september" name="september" value="{{ $paguAnggaran->anggaranPerbulan->september }}">
                                    @error('september')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('oktober') is-invalid @enderror"
                                        id="oktober" name="oktober" value="{{ $paguAnggaran->anggaranPerbulan->oktober }}">
                                    @error('oktober')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('november') is-invalid @enderror"
                                        id="november" name="november" value="{{ $paguAnggaran->anggaranPerbulan->november }}">
                                    @error('november')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('desember') is-invalid @enderror"
                                        id="desember" name="desember" value="{{ $paguAnggaran->anggaranPerbulan->desember }}">
                                    @error('desember')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
