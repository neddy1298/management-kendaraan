                    ...
                    <form method="POST" action="{{ route('kendaraan.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-sm-12 col-12">
                                <div class="mb-3">
                                    <label for="nomor_registrasi" class="form-label">Nomor Registrasi <i>( plat nomor
                                            )</i></label>
                                    <input type="text"
                                        class="form-control {{ $errors->has('nomor_registrasi') ? 'is-invalid' : '' }}"
                                        id="nomor_registrasi" value="{{ old('nomor_registrasi') }}" name="nomor_registrasi">
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        class="form-control {{ $errors->has('merk_kendaraan') ? 'is-invalid' : '' }}"
                                        id="merk_kendaraan" value="{{ old('merk_kendaraan') }}" name="merk_kendaraan">
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        class="form-control {{ $errors->has('cc_kendaraan') ? 'is-invalid' : '' }}"
                                        id="cc_kendaraan" value="{{ old('cc_kendaraan') }}" name="cc_kendaraan">
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" title="Masukkan Jenis Kendaraan" data-live-search="true"
                                        onchange="fillForm(this.value)" name="jenis_kendaraan">
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" title="Masukkan Jenis Kendaraan" data-live-search="true"
                                        onchange="fillForm(this.value)" name="bbm_kendaraan">
                                        <option hidden value=""></option>
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        class="form-control {{ $errors->has('roda_kendaraan') ? 'is-invalid' : '' }}"
                                        id="roda_kendaraan" value="{{ old('roda_kendaraan') }}" name="roda_kendaraan">
