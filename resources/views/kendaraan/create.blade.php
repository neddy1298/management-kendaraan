                            ...
                            <div class="col-xl-12 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nomor_registrasi') }}" name="nomor_registrasi">
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('merk_kendaraan') }}" name="merk_kendaraan">
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('cc_kendaraan') }}" name="cc_kendaraan">
                            ...
                            <div class="col-xl-6 col-sm-12 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('roda_kendaraan') }}" name="roda_kendaraan">
