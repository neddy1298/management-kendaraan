...
@section('css')
    <link rel="stylesheet" href="{{ mix('vendor/daterange/daterange.css') }}">
    <link rel="stylesheet" href="{{ mix('vendor/bs-select/bs-select.css') }}">
@endsection
...
@section('script')
    ...
    <!-- Bootstrap Select JS -->
    <script src="{{ mix('vendor/bs-select/bs-select.min.js') }}"></script>
    <script src="{{ mix('vendor/bs-select/bs-select-custom.js') }}"></script>

    <!-- Date Range JS -->
    <script src="{{ mix('vendor/daterange/daterange.js') }}"></script>
    <script src="{{ mix('vendor/daterange/custom-daterange.js') }}"></script>
@endsection
