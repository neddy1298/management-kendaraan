...
@section('css')
    <!-- Data Tables -->
    <link rel="stylesheet" href="{{ secure_asset('asset('vendor/datatables/dataTables.bs5.css') }}" />
    <link rel="stylesheet" href="{{ secure_asset('asset('vendor/datatables/dataTables.bs5-custom.css') }}" />
@endsection
